...
from CheckMyVisa.data_access.visa_data import VisaData
from CheckMyVisa.entity.config_entity import DataIngestionConfig
from CheckMyVisa.entity.artifact_entity import DataIngestionArtifact
...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> DataFrame:
        ...
        Returns:
            DataFrame: The exported dataframe.
        """
        try:
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            logging.info("Got the data from the database")
